...
export const qs = <T extends string>(
	dm_node: ParentNode | HTMLElement,
	sq_selector: T,
): QueryResult<T> => dm_node.querySelector(sq_selector) as QueryResult<T>;

export const qsa = <T extends string>(
	dm_node: ParentNode | HTMLElement,
	sq_selector: T,
): QueryResult<T>[] =>
...
// main content
export const dm_content = document.getElementById(
	'main-content',
) as HTMLDivElement;
