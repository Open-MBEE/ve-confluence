import type { Hash, SparqlBindings } from '../common/types';

import type { ConnectionQuery } from '../model/QueryTable';
...
function stringify_select_query_descriptor(
	g_desc: SelectQueryDescriptor,
): string {
	let s_select = '*';
	let s_from = '';
	let s_tail = '';
